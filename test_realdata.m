% Dec. 27, 2021, Y.F. Chen, apply radon transform to vertical and radial
% components of the array data. 
% Test radon transfer as a preprocessing step before deconvolution.
% Jan. 11, 2021, Modified by Quan Zhang, real data preprocessing test for Zhang et al. 2022
clear; clc; close all;
addpath ./data
addpath ./codes
